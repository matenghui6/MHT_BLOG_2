...
".css")},highlighter:function(a,b,d){(a=this.hljs.highlightAuto(a,this.hljs.getLanguage(b)?[b]:void 0))&&d(a.value)}});this.setHighlighter(e)}}});CKEDITOR.plugins.codesnippet={highlighter:m};m.prototype.highlight=function(){var a=arguments;this.ready?this.highlighter.apply(this,a):this.queue.push(function(){this.highlighter.apply(this,a)})}})();CKEDITOR.config.codeSnippet_codeClass="hljs";CKEDITOR.config.codeSnippet_theme="default";CKEDITOR.plugins.add("simage",{icons:"simage",allowedContent:"img[alt,!src,width,height,data-width,data-height]{border-style,border-width,float,height,margin‌​,margin-bottom,margi‌​n-left,margin-right,‌​margin-top,width}",init:function(f){f.addCommand("simage",{exec:function(d){a=document.createElement("input");a.setAttribute("type","file");a.setAttribute("accept",".jpg,.jpeg,.png,.tif,.gif,.svg");a.click();a.onchange=function(){file=a.files[0];$(CKEDITOR.currentInstance).trigger("imageUploading");
...
function(){b=document.querySelector(".alert-danger");b.parentNode.removeChild(b)},$(CKEDITOR.instances[curr.name]).trigger("imageUploaded")):-1==="jpeg jpg png svg gif tif svg+xml".split(" ").indexOf(file.type.split("/")[1])?(b=document.createElement("div"),b.className="message alert alert-danger",m=document.createElement("span"),m.innerHTML="The uploaded image format is not of acceptible format! Please upload an image!",b.appendChild(m),c=document.createElement("span"),c.className="close",c.innerHTML=
"X",b.appendChild(c),e=document.querySelector(".error-space"),e.appendChild(b),setTimeout(function(){alert=document.querySelector(".alert-danger");alert.parentNode.removeChild(alert)},2E4),c.onclick=function(){b=document.querySelector(".alert-danger");b.parentNode.removeChild(b)},$(CKEDITOR.instances[curr.name]).trigger("imageUploaded")):(img=new Image,img.onload=function(){inputWidth=this.width;inputHeight=this.height},img.src=window.URL.createObjectURL(file),formData=new FormData,formData.append("file",
file),loaderElem=new CKEDITOR.dom.element("loader-elem"),loaderHtmlStr='\x3cdiv style\x3d"position: relative; z-index: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none"\x3e\x3cimg src\x3d"/ajax_loader_gray_64.gif" style\x3d"width: 30px;height: 30px;margin-top: 100px;"\x3e\x3c/div\x3e',loaderDomEle=CKEDITOR.dom.element.createFromHtml(loaderHtmlStr),loaderElem.append(loaderDomEle),d.insertElement(loaderElem),CKEDITOR.currentInstance.setReadOnly(!0),
$.ajax({url:d.config.imageUploadURL,type:"POST",data:formData,processData:!1,contentType:!1}).success(function(f){return function(g,f,h){g=JSON.parse(g);g.success&&(CKEDITOR.instances[curr.name].setReadOnly(!1),url=g.data.url,elem=new CKEDITOR.dom.element("elem"),maxWidth=Math.min(inputWidth,600),maxHeight=Math.min(inputHeight,600),maxWidth/maxHeight>inputWidth/inputHeight?(width=maxWidth*inputWidth/inputHeight,height=maxHeight):maxWidth/maxHeight<inputWidth/inputHeight?(width=maxWidth,height=maxHeight*
inputHeight/inputWidth):(width=maxWidth,height=maxHeight),newLine=CKEDITOR.dom.element.createFromHtml("\x3cp\x3e\x3cbr\x3e\x3c/p\x3e"),imgElem='\x3cimg src\x3d"'+url+'" class\x3d"image-editor" data-width\x3d"'+inputWidth+'" data-height\x3d"'+inputHeight+'" height\x3d"'+height+'" width\x3d"'+width+'"\x3e',imgDomElem=CKEDITOR.dom.element.createFromHtml(imgElem),elem.append(imgDomElem),d.insertElement(newLine),d.insertElement(elem),d.insertElement(newLine),loaderElem.remove(),$(CKEDITOR.instances[curr.name]).trigger("imageUploaded"))}}(this)).error(function(d){return function(d,
f,h){CKEDITOR.instances[curr.name].setReadOnly(!1);b=document.createElement("div");b.className="message alert alert-danger";m=document.createElement("span");m.innerHTML="Image upload failed! Please try again!";b.appendChild(m);c=document.createElement("span");c.className="close";c.innerHTML="X";b.appendChild(c);e=document.querySelector(".error-space");e.appendChild(b);loaderElem.remove();$(CKEDITOR.instances[curr.name]).trigger("imageUploaded");setTimeout(function(){alert=document.querySelector(".alert-danger");
alert.parentNode.removeChild(alert)},2E4);c.onclick=function(){b=document.querySelector(".alert-danger");b.parentNode.removeChild(b)}}}(this)))}}});f.ui.addButton("SImage",{label:"Custom Image Uploader",command:"simage",toolbar:"insert"})}});CKEDITOR.config.plugins='dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,notification,button,toolbar,clipboard,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,copyformatting,div,resize,elementspath,enterkey,entities,popup,filetools,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,horizontalrule,htmlwriter,iframe,wysiwygarea,image,indent,indentblock,indentlist,smiley,justify,menubutton,language,link,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,scayt,stylescombo,tab,table,tabletools,tableselection,undo,lineutils,widgetselection,widget,notificationaggregator,uploadwidget,uploadimage,wsc,codesnippet,simage';CKEDITOR.config.skin='moono-lisa';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,bidiltr,168,,bidirtl,192,,blockquote,216,,copy-rtl,240,,copy,264,,cut-rtl,288,,cut,312,,paste-rtl,336,,paste,360,,bgcolor,384,,textcolor,408,,templates-rtl,432,,templates,456,,copyformatting,480,,creatediv,504,,find-rtl,528,,find,552,,replace,576,,flash,600,,button,624,,checkbox,648,,form,672,,hiddenfield,696,,imagebutton,720,,radio,744,,select-rtl,768,,select,792,,textarea-rtl,816,,textarea,840,,textfield-rtl,864,,textfield,888,,horizontalrule,912,,iframe,936,,image,960,,indent-rtl,984,,indent,1008,,outdent-rtl,1032,,outdent,1056,,smiley,1080,,justifyblock,1104,,justifycenter,1128,,justifyleft,1152,,justifyright,1176,,language,1200,,anchor-rtl,1224,,anchor,1248,,link,1272,,unlink,1296,,bulletedlist-rtl,1320,,bulletedlist,1344,,numberedlist-rtl,1368,,numberedlist,1392,,maximize,1416,,newpage-rtl,1440,,newpage,1464,,pagebreak-rtl,1488,,pagebreak,1512,,pastetext-rtl,1536,,pastetext,1560,,pastefromword-rtl,1584,,pastefromword,1608,,preview-rtl,1632,,preview,1656,,print,1680,,removeformat,1704,,save,1728,,selectall,1752,,showblocks-rtl,1776,,showblocks,1800,,source-rtl,1824,,source,1848,,specialchar,1872,,scayt,1896,,table,1920,,redo-rtl,1944,,redo,1968,,undo-rtl,1992,,undo,2016,,spellchecker,2040,,codesnippet,2064,,simage,4176,auto','icons_hidpi.png');else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,bidiltr,168,auto,bidirtl,192,auto,blockquote,216,auto,copy-rtl,240,auto,copy,264,auto,cut-rtl,288,auto,cut,312,auto,paste-rtl,336,auto,paste,360,auto,bgcolor,384,auto,textcolor,408,auto,templates-rtl,432,auto,templates,456,auto,copyformatting,480,auto,creatediv,504,auto,find-rtl,528,auto,find,552,auto,replace,576,auto,flash,600,auto,button,624,auto,checkbox,648,auto,form,672,auto,hiddenfield,696,auto,imagebutton,720,auto,radio,744,auto,select-rtl,768,auto,select,792,auto,textarea-rtl,816,auto,textarea,840,auto,textfield-rtl,864,auto,textfield,888,auto,horizontalrule,912,auto,iframe,936,auto,image,960,auto,indent-rtl,984,auto,indent,1008,auto,outdent-rtl,1032,auto,outdent,1056,auto,smiley,1080,auto,justifyblock,1104,auto,justifycenter,1128,auto,justifyleft,1152,auto,justifyright,1176,auto,language,1200,auto,anchor-rtl,1224,auto,anchor,1248,auto,link,1272,auto,unlink,1296,auto,bulletedlist-rtl,1320,auto,bulletedlist,1344,auto,numberedlist-rtl,1368,auto,numberedlist,1392,auto,maximize,1416,auto,newpage-rtl,1440,auto,newpage,1464,auto,pagebreak-rtl,1488,auto,pagebreak,1512,auto,pastetext-rtl,1536,auto,pastetext,1560,auto,pastefromword-rtl,1584,auto,pastefromword,1608,auto,preview-rtl,1632,auto,preview,1656,auto,print,1680,auto,removeformat,1704,auto,save,1728,auto,selectall,1752,auto,showblocks-rtl,1776,auto,showblocks,1800,auto,source-rtl,1824,auto,source,1848,auto,specialchar,1872,auto,scayt,1896,auto,table,1920,auto,redo-rtl,1944,auto,redo,1968,auto,undo-rtl,1992,auto,undo,2016,auto,spellchecker,2040,auto,codesnippet,2064,auto,simage,2088,auto','icons.png');})();CKEDITOR.lang.languages={"zh-cn":1,"en":1};}());